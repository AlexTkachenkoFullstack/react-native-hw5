...
const Comment = ({ author, text, date }) => {
    ...
    if (!isOwner) {
        ...
        <View style={styles.commentContainer}>
            <Image style={styles.img}  source={{uri:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5IMlPUgreOx1p_Pxp9iVb7ivXO1LKodsoIBo9UnKjuHZlBcLO37enqghlYyzmRARo-5I&usqp=CAU'}}/>
